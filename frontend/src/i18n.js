...
const resources = {
  en: {
    translation: {
      ...
      students: "Students",
      excellentLabel: "Excellent (>=8)",
      goodLabel: "Good (6-8)",
      averageLabel: "Average (4-6)",
      weakLabel: "Weak (<4)",
      top10Title: "Top 10 - Group A (Math + Physics + Chemistry)",
      top10Chart: "Top 10 Scores Comparison",
  ...
  vi: {
    translation: {
      ...
      students: "Thí sinh",
      excellentLabel: "Giỏi (>=8)",
      goodLabel: "Khá (6-8)",
      averageLabel: "Trung bình (4-6)",
      weakLabel: "Yếu (<4)",
      top10Title: "Top 10 - Khối A (Toán + Lý + Hóa)",
      top10Chart: "So sánh tổng điểm Top 10",
